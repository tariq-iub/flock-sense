...
class DailyReportService
{
    ...
    private function formatUrdu($shed, $flock, $data): array
    {
        return [
            ...
            'دن پانی صرف شدہ' => round($data->day_water_consumed / 1000, 2).' لیٹر ',
            'شب پانی صرف شدہ' => round($data->night_water_consumed / 1000, 2).' لیٹر ',
            'اوسط پانی صرف شدہ' => round($data->avg_water_consumed / 1000, 2).' لیٹر ',
