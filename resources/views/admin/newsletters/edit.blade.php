        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6>Update newsletter details and content.</h6>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">
                            <i class="ti ti-mail text-primary me-2"></i>Edit Newsletter
                        </h5>
                    </div>
                    <form action="{{ route('newsletters.update', $newsletter) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content_html"
                                              ...
                                              required>{{ old('content_html', $newsletter->content_html) }}</textarea>
                                    @error('content_html')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content_text"
                                              ...
                                              rows="6"
                                              placeholder="Enter plain text version (optional)">{{ old('content_text', $newsletter->content_text) }}</textarea>
                                    @error('content_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                        ...
                                        <option value="failed" {{ old('status', $newsletter->status) === 'failed' ? 'selected' : '' }}>Failed</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local"
                                           ...
                                           value="{{ old('send_at', $newsletter->send_at ? $newsletter->send_at->format('Y-m-d\TH:i') : '') }}">
                                    @error('send_at')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                @if($newsletter->last_error)
                                    <div class="col-12">
                                        <div class="alert alert-danger">
                                            <strong><i class="feather-alert-triangle me-2"></i>Last Error:</strong>
