...
@section('content')
    <div class="main-wrapper">
        <div class="error-box">
            ...
            <p>
                You do not have permission to access this resource. This error, indicated by the HTTP status code 401,<br>
                typically occurs when your login credentials (username and password) are incorrect or when you don't have<br>
